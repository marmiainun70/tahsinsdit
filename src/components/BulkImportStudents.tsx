...
const LEVEL_COLORS: Record<string, string> = {
  "Iqro 1": "bg-primary/10 text-primary",
  "Iqro 2": "bg-primary/10 text-primary",
  "Iqro 3": "bg-secondary/50 text-secondary-foreground",
  "Iqro 4": "bg-secondary/50 text-secondary-foreground",
  "Iqro 5": "bg-accent/60 text-accent-foreground",
  "Iqro 6": "bg-accent/60 text-accent-foreground",
  "Tahsin Lanjutan": "bg-muted text-muted-foreground",
  "Tahfizh": "bg-primary/20 text-primary",
};
