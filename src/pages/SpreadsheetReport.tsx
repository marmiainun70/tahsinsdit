    ...
    <div className="p-3 md:p-6 space-y-4 max-w-[1700px] mx-auto">
      ...
      <Card>
        <CardContent className="p-0 overflow-x-auto">
          <table className="w-full text-xs border-collapse border border-black dark:border-white/20 min-w-[1150px]">
            <thead className="bg-[#107c41] text-white sticky top-0 z-10">
              <tr className="text-center">
                <th className="p-1 border border-black dark:border-white/25 w-8 text-center align-middle text-[11px] font-semibold">#</th>
                <th className="p-1 border border-black dark:border-white/25 w-[160px] text-center align-middle text-[11px] font-semibold">Nama Siswa</th>
                <th className="p-1 border border-black dark:border-white/25 w-[75px] text-center align-middle text-[11px] font-semibold">Program</th>
                <th className="p-1 border border-black dark:border-white/25 w-[70px] text-center align-middle text-[11px] font-semibold">Awal</th>
                <th className="p-1 border border-black dark:border-white/25 w-[80px] text-center align-middle text-[11px] font-semibold">Hal. Awal</th>
                <th className="p-1 border border-black dark:border-white/25 w-[70px] text-center align-middle text-[11px] font-semibold">Akhir</th>
                <th className="p-1 border border-black dark:border-white/25 w-[80px] text-center align-middle text-[11px] font-semibold">Hal. Akhir</th>
                <th className="p-1 border border-black dark:border-white/25 w-10 text-center align-middle text-[11px] font-semibold">Total</th>
                <th className="p-1 border border-black dark:border-white/25 w-10 text-center align-middle text-[11px] font-semibold">Target</th>
                <th className="p-1 border border-black dark:border-white/25 w-20 text-center align-middle text-[11px] font-semibold">Status</th>
                <th className="p-1 border border-black dark:border-white/25 w-10 text-center align-middle text-[11px] font-semibold" title="Hadir">H</th>
                <th className="p-1 border border-black dark:border-white/25 w-10 text-center align-middle text-[11px] font-semibold" title="Sakit">S</th>
                <th className="p-1 border border-black dark:border-white/25 w-10 text-center align-middle text-[11px] font-semibold" title="Izin">I</th>
                <th className="p-1 border border-black dark:border-white/25 w-10 text-center align-middle text-[11px] font-semibold" title="Alpha">A</th>
                <th className="p-1 border border-black dark:border-white/25 min-w-[180px] text-center align-middle text-[11px] font-semibold">Catatan</th>
                <th className="p-1 border border-black dark:border-white/25 w-24 text-center align-middle text-[11px] font-semibold">Status Simpan</th>
              </tr>
            </thead>
            <tbody>
              {rows.length === 0 && (
                <tr><td colSpan={16} className="p-6 text-center text-muted-foreground border border-black dark:border-white/20">Belum ada siswa pada filter ini.</td></tr>
              )}
              {rows.map((r, idx) => {
                const target = getTarget(r.program);
                ...
                return (
                  <tr key={r.studentId} className={`divide-x divide-black dark:divide-white/20 ${r.dirty ? "bg-amber-50/50 dark:bg-amber-950/20" : decline ? "bg-red-50/30 dark:bg-red-950/20" : "hover:bg-muted/10"}`}>
                    <td className="p-1 border border-black dark:border-white/20 text-center text-muted-foreground text-[11px]">{idx + 1}</td>
                    <td className="p-1 border border-black dark:border-white/20 font-medium text-[11px]">
                      <div>{r.studentName}</div>
                      <div className="text-[9px] text-muted-foreground">{r.studentLevel}</div>
                    </td>
                    <td className="p-0 border border-black dark:border-white/20">
                    ...
                    <td className="p-0.5 border border-black dark:border-white/20">
                    ...
                    <td className={`p-1 border border-black dark:border-white/20 text-center font-mono text-[11px] ${signed < 0 ? "text-red-600 font-bold" : ""}`}>{hasEnd ? signed : "-"}</td>
                    <td className="p-1 border border-black dark:border-white/20 text-center font-mono text-muted-foreground text-[11px]">{target}</td>
                    <td className="p-1 border border-black dark:border-white/20 text-center">{hasEnd ? <span className="scale-90 inline-block">{statusBadge}</span> : <span className="text-muted-foreground text-[11px]">-</span>}</td>
                    {(["present", "sick", "permission", "absent"] as const).map(k => (
                      <td key={k} className="p-0 border border-black dark:border-white/20">
                        <Input
                          type="number" min={0}
                          value={r[k]}
                    ...
                    <td className="p-1 border border-black dark:border-white/20">
                    ...
                    <td className="p-1 border border-black dark:border-white/20 text-center text-[11px]">
